...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     KW_TRANSPORT = 16326,
     KW_IP_TTL = 16327,
     KW_SO_BROADCAST = 16328,
     KW_IP_TOS = 16329,
     KW_SO_SNDBUF = 16330,
     KW_SO_RCVBUF = 16331,
     KW_SO_KEEPALIVE = 16332,
     KW_SPOOF_SOURCE = 16333,
     KW_KEEP_ALIVE = 16334,
     KW_MAX_CONNECTIONS = 16335,
     KW_LOCALIP = 16336,
     KW_IP = 16337,
     KW_LOCALPORT = 16338,
     KW_DESTPORT = 16339,
...
/* Tokens.  */
#define KW_MEF 16325
#define KW_TRANSPORT 16326
#define KW_IP_TTL 16327
#define KW_SO_BROADCAST 16328
#define KW_IP_TOS 16329
#define KW_SO_SNDBUF 16330
#define KW_SO_RCVBUF 16331
#define KW_SO_KEEPALIVE 16332
#define KW_SPOOF_SOURCE 16333
#define KW_KEEP_ALIVE 16334
#define KW_MAX_CONNECTIONS 16335
#define KW_LOCALIP 16336
#define KW_IP 16337
#define KW_LOCALPORT 16338
#define KW_DESTPORT 16339
