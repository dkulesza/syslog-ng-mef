...
gboolean
afmef_setup_socket(gint fd, SocketOptions *sock_options, AFSocketDirection dir)
{
  gint rc;
...
gboolean
afmef_open_socket(GSockAddr *bind_addr, gint sock_type, gint sock_protocol, int *fd)
{
  gint sock;
